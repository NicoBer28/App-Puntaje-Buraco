        ...
        btnLogin.setOnClickListener {
            ...
            if (usuarioIngresado == "") {
                ...
                if (usuarioIngresado.length > 8) {
                    Toast.makeText(requireContext(), "Debe contener máximo 8 caracteres", Toast.LENGTH_SHORT).show()
                } else {
                    db.collection("users")
                        ...
                        .addOnFailureListener { e ->
                            Toast.makeText(requireContext(), "Error al verificar usuario: $e", Toast.LENGTH_SHORT).show()
                        }
                }
            }
        }
